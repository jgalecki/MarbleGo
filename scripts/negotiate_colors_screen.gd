...
@onready var selection_play_black_button = $"MarginContainer/Color Selection/HBoxContainer/Play Black"
@onready var selection_play_white_button = $"MarginContainer/Color Selection/HBoxContainer/Play White"
