...
#		shooting_marble.set_multiplayer_authority($"/root/Lobby".guest_player_id, true)
	...
	print($"/root/Lobby".player_info.name + ": shooting marble has index of " + str(shooting_marble.placed_index) + ", player of " + str(shooting_marble.player))
	print($"/root/Lobby".player_info.name + ": Marble init'ed for player " + str(player_id))
